...
const emptyForm = { name: "", address: "", region: "" };
...
export default function Stations() {
  ...
  const validate = () => {
    ...
    if (!form.region.trim()) errors.region = t("regionRequired");
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-[#c9d1d9]">{t("stations")}</h2>
        <button
          onClick={openAdd}
      ...
      {loading ? (
        ...
        <div className="text-center py-20 bg-[#161b22] rounded-xl shadow-sm border border-[#30363d]">
          <p className="text-[#8b949e] text-lg">{t("noStations")}</p>
          <button
            onClick={openAdd}
              ...
              <tbody className="divide-y divide-[#30363d]">
                {stations.map((station) => (
                  <tr
                    ...
                    onClick={() => {
                      window.location.hash = `#/stations/${station.id}`;
                    }}
                  >
                    ...
                    <td className="px-6 py-4 text-center">
                      <span
                        className={`inline-flex px-2.5 py-1 rounded-full text-xs font-medium ${station.isActive !== false ? "bg-[#1a3a2a] text-[#3fb950]" : "bg-[#490202] text-[#f85149]"}`}
                      >
          ...
          >
            <div className="flex items-center justify-between px-6 py-4 border-b border-[#30363d]">
              <h3 className="text-lg font-bold text-[#c9d1d9]">
                {editingId ? t("editStation") : t("newStation")}
              </h3>
              <button
                onClick={() => setShowModal(false)}
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#58a6ff] focus:border-[#58a6ff] outline-none bg-[#0d1117] text-[#c9d1d9] ${formErrors.address ? "border-[#f85149]" : "border-[#30363d]"}`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-[#58a6ff] focus:border-[#58a6ff] outline-none bg-[#0d1117] text-[#c9d1d9] ${formErrors.region ? "border-[#f85149]" : "border-[#30363d]"}`}
